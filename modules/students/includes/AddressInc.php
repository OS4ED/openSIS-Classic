...
if (!$_REQUEST['modfunc']) {
    ...
    if ($_REQUEST['person_id'] == 'new') {
        if ($_REQUEST['address_id'] != 'new')
            echo '<li class="list-group-item"><a href="javascript:void(0);" onclick="document.location.href=\'Modules.php?modname=' . $_REQUEST['modname'] . '&include=' . $_REQUEST['include'] . '&address_id=' . $_REQUEST['address_id'] . '\';" >';
        else
            echo '<li class="list-group-item"><a href="javascript:void(0);" onclick="document.location.href=\'Modules.php?modname=' . $_REQUEST['modname'] . '&include=' . $_REQUEST['include'] . '&address_id=new\';" >';
        ...
        elseif ($_REQUEST['person_id'] != $contact['PERSON_ID'])
            ...
            $active = 'active';
        echo '<li class="list-group-item ' . $active . '"><a href="javascript:void(0);" onclick="document.location.href=\'Modules.php?modname=' . $_REQUEST['modname'] . '&include=' . $_REQUEST['include'] . '&address_id=$_REQUEST[address_id]\';">';
        echo 'Student\'s Address';
    }
    ...
    if (isset($_REQUEST['address_id']) && $_REQUEST['con_info'] != 'old') {
        ...
        if ($_REQUEST['address_id'] != '0' && $_REQUEST['address_id'] !== 'old') {
            ...
            if ($m_addr[1]['ADDRESS_ID'] != '' && $h_addr[1]['ADDRESS_ID'] != '') {
                $s_mail_address = DBGet(DBQuery('SELECT COUNT(1) as TOTAL FROM student_address WHERE ID!=\'' . $m_addr[1]['ADDRESS_ID'] . '\' AND STREET_ADDRESS_1=\'' . singleQuoteReplace('', '', $m_addr[1]['ADDRESS']) . '\' '.($m_addr[1]['STREET']!=''?'AND STREET_ADDRESS_2=\'' . singleQuoteReplace('', '', $m_addr[1]['STREET']) . '\'':' ').'   AND CITY=\'' . singleQuoteReplace('', '', $m_addr[1]['CITY']) . '\' AND STATE=\'' . singleQuoteReplace('', '', $m_addr[1]['STATE']) . '\' AND ZIPCODE=\'' . singleQuoteReplace('', '', $m_addr[1]['ZIPCODE']) . '\' AND TYPE=\'Home Address\' AND STUDENT_ID='. UserStudentID()));
            ...
            echo '<div class="row">';
            if ($h_addr[1]['ADDRESS_ID'] != 0)
                echo '<div class="col-md-6"><div class="form-group"><label class="control-label text-right col-md-4">&nbsp;</label><div class="col-md-8"><div id="check_addr"><label class="checkbox-inline"><input type="checkbox" ' . $m_checked . ' id="same_addr" name="same_addr" set_check_value value="Y">&nbsp;Same as Home Address &nbsp;</label></div></div></div></div>';
            if ($h_addr[1]['ADDRESS_ID'] == 0)
            ...
            if ($portal_check == '')
                ...
                echo '<div class="col-md-6"><div class="form-group"><label class="control-label text-right col-md-4">Portal User</label><div class="col-md-8"><div id=checked_1><i class="icon-checkbox-checked"></i></div></div></div></div>';
            echo '</div>'; //.row
            ...
            if ($h_addr[1]['ADDRESS_ID'] != '' && $p_addr[1]['ADDRESS_ID'] != '') {
                ...
                $s_prim_address = DBGet(DBQuery('SELECT COUNT(1) as TOTAL FROM student_address WHERE ID!=\'' . $p_addr[1]['ADDRESS_ID'] . '\' AND STREET_ADDRESS_1=\'' . singleQuoteReplace('', '', $p_addr[1]['ADDRESS']) . '\'  '.($p_addr[1]['STREET']!=''?'AND STREET_ADDRESS_2=\'' . singleQuoteReplace('', '', $p_addr[1]['STREET']) . '\'':' ').'  AND CITY=\'' . singleQuoteReplace('', '', $p_addr[1]['CITY']) . '\' AND STATE=\'' . singleQuoteReplace('', '', $p_addr[1]['STATE']) . '\' AND ZIPCODE=\'' . $p_addr[1]['ZIPCODE'] . '\' AND TYPE=\'Home Address\' AND STUDENT_ID='.UserStudentID().' '));
                ...
                if ($p_addr[1]['ADDRESS_ID'] != 0)
                    echo '<div class="col-md-6"><div class="form-group"><label class="control-label text-right col-md-4">&nbsp;</label><div class="col-md-8"><div id="check_addr"><label class="checkbox-inline"><input type="checkbox" ' . $p_checked . ' id="prim_addr" name="prim_addr" value="Y">Same as Home Address</label></div></div></div></div>';
            }
            echo '</div>'; //.row
            ...
            if ($h_addr[1]['ADDRESS_ID'] != 0) {
                echo '<div class="row">';
                echo '<div class="col-md-6"><div class="form-group"><label class="control-label text-right col-md-4">&nbsp;</label><div class="col-md-8"><div id="check_addr"><label class="checkbox-inline"><input type="checkbox" ' . $s_checked . ' id="sec_addr" name="sec_addr" value="Y">Same as Home Address</label></div></div></div></div>';
                echo '</div>'; //.row 
            }
    ...
    if ($_REQUEST['person_id'] != 'old') {
        ...
        if ($_REQUEST['person_id'] != 'new' && $_REQUEST['con_info'] == 'old') {
            ...
            if ($portal_check == ''){
                ...
                echo '<div class="col-md-6"><label class="control-label text-right col-md-4">Portal User</label><div class="col-md-8"><i class="icon-checkbox-checked"></i></div></div>';
            }
            echo '</div>'; //.row
