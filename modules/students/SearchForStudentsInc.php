...
if ($_REQUEST['search_modfunc'] == 'search_fnc' || !$_REQUEST['search_modfunc']) {
    ...
    switch (User('PROFILE')) {
        ...
        case 'teacher':
            ...
            echo '<div class="row">';
            echo '<div class="col-md-6">';
            echo '<div class="form-group"><label class="control-label col-lg-4 text-right">'._relationshipToStudent.' </label><div class="col-lg-8">'.SelectInput('', 'primary_realtionship', '', 
                array('Father' => _father,
                    'Mother' => _mother,
                    'Step Mother' => _mother,
            ...
            echo '<div class="row">';
            echo '<div class="col-md-6">';
            echo '<div class="form-group"><label class="control-label col-lg-4 text-right">'._relationshipToStudent.' </label><div class="col-lg-8">'.SelectInput('', 'secondary_realtionship', '', 
            array('Father' => _father,
                'Mother' => _mother,
                'Step Mother' => _mother,
                'Step Father' => _stepFather,
