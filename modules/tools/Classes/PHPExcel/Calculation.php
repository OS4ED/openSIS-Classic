...
class PHPExcel_Calculation {
	...
	private static $_PHPExcelFunctions = array(	// PHPExcel functions
				...
				'FALSE'					=> array('category'			=>	PHPExcel_Calculation_Function::CATEGORY_LOGICAL,
												 'functionCall'		=>	'PHPExcel_Calculation_Functions::LOGICALfalse',
												 'argumentCount'	=>	'0'
												),
				...
				'TRUE'					=> array('category'			=>	PHPExcel_Calculation_Function::CATEGORY_LOGICAL,
												 'functionCall'		=>	'PHPExcel_Calculation_Functions::LOGICALtrue',
												 'argumentCount'	=>	'0'
												),
	...
	public function setLocale($locale='en_us') {
		...
		if (in_array($language,self::$_validLocaleLanguages)) {
			...
			self::$functionReplaceFromLocale = self::$functionReplaceToLocale = _NULL;
	...
	private static $functionReplaceFromExcel	= _NULL;
	private static $functionReplaceToLocale		= _NULL;
	...
	private static $functionReplaceFromLocale	= _NULL;
	private static $functionReplaceToExcel		= _NULL;
...
//				echo 'Element is a Function argument separator<br />';
				...
				if (($expectingOperand) || (!$expectingOperator)) {
					$output[] = array('type' => 'NULL Value', 'value' => self::$_ExcelConstants['NULL'], 'reference' =>_NULL);
				}
...
//					echo 'Element '.$val.' is a Function<br />';
					if (array_key_exists(strtoupper($matches[1]), self::$_PHPExcelFunctions) || array_key_exists(strtoupper($matches[1]), self::$_controlFunctions)) {	// it's a func
						...
						$output[] = array('type' => 'Value', 'value' => $matches[1], 'reference' =>_NULL);
					}
...
//						echo 'Element '.$localeConstant.' is an Excel Constant<br />';
					...
					$details = array('type' => 'Value', 'value' => $val, 'reference' =>_NULL);
...
//				echo 'Adjusted Range reference is '.$pRange.'<br />';
			...
			if (count($aReferences) == 1) {
				...
				if ($pSheet->cellExists($aReferences[0])) {
					...
					$returnValue[$currentRow][$currentCol] = _NULL;
				}
			} else {
				// Extract cell data
