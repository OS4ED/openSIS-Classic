...
//					echo 'Element is an Intersect Operator<br />';
		...
		while (!is_null($op = $stack->pop())) {	// pop everything off the stack and push onto output
			if (!empty($opCharacter['value']) && $opCharacter['value'] == '(') return $this->_raiseFormulaError("Formula Error: Expecting ')'");	// if there are any opening braces on the stack, then braces were unbalanced
			$output[] = $op;
		}
		return $output;
