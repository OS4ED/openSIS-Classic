            ...
            <div class="login-wrapper">
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <h3>openSIS Installation - Database Allocation</h3>
                    </div>
                        ...
                        <div class="installation-steps-wrapper">
                            <div class="installation-instructions">
                                <ul class="installation-steps-label">
                                    ...
                                    <li class="active">Database Allocation</li>
                                ...
                                <p>Remember the Database Allocation takes some time, so please be patient and do not close the browser.</p>-->
                            </div>
