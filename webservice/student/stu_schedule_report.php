...
//        $row_mp_detail = mysql_fetch_array($res_mp_detail);
    ...
    {
       $data = array('schedule_data' => '', 'success' => 0, 'msg' => 'Not authenticated user'); 
    }
}
else 
{
