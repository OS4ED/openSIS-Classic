...
//        $path ='../../assets/studentphotos/';
        ...
        if($mp_success == 1 || $success == 1)
            ...
            $all_success = 0;
        $data = array('mp_data'=>$pro_data,'outof'=>count($students_RET),'selected_mp'=>$gpa_mp_id,'mp_success'=>$mp_success,'mp_msg'=>$mp_msg,'student_data'=>$student_data,'student_success'=>$success,'success'=>$all_success,'student_msg'=>$msg);
    }
    else 
    {
