...
$data = array('selected_student'=>$student_id,'selected_mp'=>$mp_id1,'schedule_data'=>$schedule_data,'success'=> $success,'msg'=>$msg,'mp_data'=>$marking_period_data,'mp_success'=>$mp_success);
