...
if ($_POST['button'] == 'Clear & Exit') {
      ...
      echo '<INPUT type=button name=button class="btn btn-primary" value=Clear & Exit  onclick="BlockModalPeriod(\''.$subject_id.'\','.$course_id.',\''.$cp_id.'\',\''.$calendar_id.'\',\''.$meet_date.'\',\'edit\',\''.$id.'\')";> &nbsp ';
